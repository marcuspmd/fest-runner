...
export interface TestGeneratedMessage extends Message<GeneratedTest & { success: boolean }> {
  type: 'test-generated';
}

export interface UrlValidatedMessage extends Message<{ valid: boolean; error?: string }> {
  type: 'url-validated';
}
